    ...
    <>
      <div
        className={`navbar-menu-wrapper flex-grow d-flex align-items-stretch ${
          isSidebarIconOnly ? "sidebar-icon-only" : ""
        }`}
      >
        <button
        ...
        <ul className="navbar-nav navbar-nav-right">
          ...
          <li
            className={`nav-item dropdown border-left ${
              hoveredItem === "messages" ? "hover-open" : ""
            }`}
          ...
          <li
            className={`nav-item dropdown border-left ${
              hoveredItem === "notifications" ? "hover-open" : ""
            }`}
